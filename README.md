# 🥊 **MEGA_UTILS – THE UNDISPUTED CHAMPION OF UTILITY LIBRARIES!** 🥊  
...
❗ **Step 0:** Make sure you have ***SDL2***, ***SDL2 image***, ***SDL2 tff***, ***SDL2 mixer*** and ***nlohmann json*** (sprite.h) packages installed if you want to use them!
